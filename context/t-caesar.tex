...
\starttypescript[me]
    ...
    \definetypeface [me] [mm] [math]  [pagella] [default]
\stoptypescript
...
%title page
\define[3]\maketitlepage{%
{\ss\tfc\noindent\kerncharacters[0.125]\uppercase{#1}}\par%
\blank[100pt]%
{\setupbodyfont[sansserif,38pt]\setupinterlinespace[line=50pt]\noindent\kerncharacters[0.15]\uppercase{#2}}\par%
\vfill%
{\ss\tfc\kerncharacters[0.125]\uppercase{#3}}%
}
